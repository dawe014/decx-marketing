...
const ProfileSidebar = ({ influencer }) => {
  const router = useRouter(); // Added to handle navigation
  ...
  return (
    <div className="w-full md:w-1/3 lg:w-1/4 flex flex-col items-center">
      ...
      <button
        ...
        className="mt-3 w-full bg-slate-700 hover:bg-slate-600 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center"
      >
