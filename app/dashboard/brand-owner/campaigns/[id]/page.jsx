...
import { useCampaignDetails } from "@/hooks/useCampaignDetails"; // Adjust path if needed
import ApplicantDetailsModal from "@/components/campaigns/ApplicantDetailsModal"; // Adjust path if needed
import {
  getStatusColor,
  getStatusIcon,
  formatDate,
  getSafeValue,
} from "@/components/campaigns/ui-helpers"; // Adjust path if needed
import { use } from "react";

// ====================================================================================
// SUB-COMPONENT 1: CampaignOverviewTab
// In a real project, this would be in its own file: components/campaigns/CampaignOverviewTab.js
// ====================================================================================
  ...
  return (
    <div className="bg-slate-800 rounded-xl shadow-lg border border-slate-700 overflow-hidden">
            ...
            {getSafeValue(job, "deliverables", []).length > 0 ? (
              job.deliverables.map((d, i) => (
                <div key={i} className="bg-slate-700/30 p-4 rounded-lg">
                  ...
                  {d.description && (
                    <p className="mt-2 text-slate-300">{d.description}</p>
                  )}
                </div>
              ))
            ) : (
      ...
      <div className="bg-slate-700/50 p-4 border-t border-slate-700 flex justify-end">
        <button
          onClick={() =>
            router.push(`/dashboard/brand-owner/campaigns/edit/${job._id}`)
          }
...
// ====================================================================================
// SUB-COMPONENT 2: ApplicantsTab
// In a real project, this would be in its own file: components/campaigns/ApplicantsTab.js
// ====================================================================================
const ApplicantsTab = ({
  applicants,
  searchTerm,
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4 flex-1 min-w-0">
                    <div className="relative mt-1">
                      <div className="bg-gradient-to-br from-indigo-500 to-purple-600 w-12 h-12 rounded-full flex items-center justify-center overflow-hidden">
