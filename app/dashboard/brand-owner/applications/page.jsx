  ...
  const [applications, setApplications] = useState([
    {
      ...
      date: "2023-11-18",
      message:
        "I have experience promoting SaaS tools and believe my audience would be a great fit for your product.",
    ...
    },
    {
      ...
      date: "2023-11-15",
      message:
        "My fitness-focused audience regularly looks for quality supplements like yours.",
    ...
    },
    {
      ...
      date: "2023-11-10",
      message:
        "I specialize in travel gear reviews and would love to showcase your product.",
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start gap-4">
                  ...
                  <div className="flex items-start space-x-3 min-w-[200px]">
                    ...
                    <div>
                      <h3 className="font-thin text-white">
                        {application.influencer.name}
                      </h3>
                      <p className="text-sm text-indigo-400">
                        {application.influencer.handle}
                      </p>
                      <div className="flex items-center mt-1 text-xs text-slate-400">
                        <span className="mr-2">
                          {application.influencer.followers} followers
                        </span>
                        <span>
